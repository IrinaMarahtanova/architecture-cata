...
#### 1. ПС-1 Регистрация посетителей
Посетители регистрируются на выбранные ими мероприятия
#### 2. ПС-2 Управление расписанием мероприятий
...
все участники системы видят проводимые мероприятия, кто их проводит, материалы и количество зарегистрированных
посетителей
#### 7. ПС-7 Изменение внешнего вида страниц выступлений, добавление логотипов  
...
#### Атрибуты качества
1. система должна выдерживать высокую нагрузку во время голосования, поскольку потенциально могут голосовать порядка 
во время конференции 335 миллионов посетителей, проживающих в США, то есть при равномерной нагрузке порядка 9000 голосов в секунду.
2. доступность сервисов: доля ошибочных ответов от сервиса не должна превышать 1% от общего количества ответов сервиса.
3. время ответа сервиса: время ответов сервиса не должно превышать 5 секунд в 95% случаев, за исключением формирования отчетов.
4. надежность: во время сбоя система должна подтянуть изменения, которые не были сохранены в системе.
...
### Диграмма последовательности для сценария просмотра расписания конференции и мест ее проведения
