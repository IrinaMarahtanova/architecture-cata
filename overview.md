...
3. надежность: не должно быть утерянных мероприятий и материалов
4. время разработки (time to market)
5. стоимость разработки (budget/cost)
6. во время сбоя система должна подтянуть изменения, которые не были сохранены в системе
