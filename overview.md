...
2. Создать простой сайт средствами управления содержимым сайта, например, Wordpress по созданию, редактирования расписания конференций. Систему голосования не разрабатывать, функции оставить на отделе поддержки, как это выполняется сейчас клиентом.
